...
Loop Creator는 그 비용을 줄이기 위해 scaffold 단계부터 Goal Contract, Learning Trace, eval pack, evidence ledger, failure taxonomy, runner-neutral spec, review report, validator를 강제한다.
